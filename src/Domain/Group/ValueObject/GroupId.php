...
use Mainfreme\UserProfile\Domain\Group\Exception\InvalidGroupIdException;
...
final readonly class GroupId
{
    ...
    public static function fromString(string $value): self
    {
        ...
        if ('' === $trimmed) {
            throw InvalidGroupIdException::empty();
        }

        if (!preg_match(self::PATTERN, $trimmed)) {
            throw InvalidGroupIdException::invalidFormat($value);
        }
