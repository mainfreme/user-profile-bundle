 ...
 *     },
 * }
 * @psalm-type UserProfileConfig = array{
 *     bio_max_length?: int|Param, // Default: 2000
 *     default_role?: scalar|Param|null, // Default: "ROLE_USER"
 *     allowed_roles?: list<scalar|Param|null>,
 *     role_tree?: list<array{ // Default: [{"role":"ROLE_ADMIN","label":"Administrator","children":[{"role":"ROLE_MODERATOR","label":"Moderator","children":[{"role":"ROLE_USER","label":"Użytkownik","children":[]}]}]}]
 *         role?: scalar|Param|null,
 *         label?: scalar|Param|null,
 *         children?: mixed, // Default: []
 *     }>,
 *     storage?: array{
 *         driver?: "memory"|"filesystem"|Param, // Default: "filesystem"
 *         filesystem?: array{
 *             root?: scalar|Param|null, // Default: "%kernel.project_dir%/var/users"
 *         },
 *     },
 * }
